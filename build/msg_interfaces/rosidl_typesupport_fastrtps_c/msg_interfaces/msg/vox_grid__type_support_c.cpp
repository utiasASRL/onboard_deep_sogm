...
#include "msg_interfaces/msg/vox_grid__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/point__functions.h"  // origin
...
using _VoxGrid__ros_msg_type = msg_interfaces__msg__VoxGrid;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _VoxGrid__ros_msg_type * ros_message = static_cast<const _VoxGrid__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _VoxGrid__ros_msg_type * ros_message = static_cast<_VoxGrid__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_msg_interfaces__msg__VoxGrid(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VoxGrid__ros_msg_type * ros_message = static_cast<const _VoxGrid__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _VoxGrid__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_msg_interfaces__msg__VoxGrid(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_interfaces
size_t max_serialized_size_msg_interfaces__msg__VoxGrid(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_msg_interfaces__msg__VoxGrid(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_VoxGrid = {
  "msg_interfaces::msg",
  "VoxGrid",
...
static rosidl_message_type_support_t _VoxGrid__type_support = {
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_interfaces, msg, VoxGrid)() {
  return &_VoxGrid__type_support;
}
